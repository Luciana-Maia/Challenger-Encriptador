function codificar() {
    let TextoCriptografado = input.value.replace(/a|e|i|o|u/g,function(ocorrencia){
...
function decodificar() {
    let TextoCriptografado = input.value.replace(/ai|enter|imes|ober|ufat/g,function(ocorrencia){
